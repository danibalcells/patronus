...
- **paper_roundup**: A bullet list of papers, each with one line. Aim for 4-8 items. Breadth over depth.
  - **Recency is the default.** The large majority of items (all but 1-2) should be under 1 month old. Freshness is a strong prior — only publish old papers if they are clearly foundational knowledge (check citations for papers > 1 year old to see that they have been influential before including them in the final digest)
